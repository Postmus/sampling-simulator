...
```bash
npm install @stdlib/stats-base-dists-chisquare-skewness
```
...
[test-image]: https://github.com/stdlib-js/stats-base-dists-chisquare-skewness/actions/workflows/test.yml/badge.svg?branch=v0.3.1
[test-url]: https://github.com/stdlib-js/stats-base-dists-chisquare-skewness/actions/workflows/test.yml?query=branch:v0.3.1
